    ...
    if referral_code:
        ...
        if invited >= limit:
            text = (
                ...
                "Но вы по прежнему будете получать бонусные дни, если пригласите человека и он оплатит подписку."
            ...
            text = (
                ...
                "Если пользователь, которого вы пригласили оплатит подписку, то вы получите 10% бонусными днями."
            )

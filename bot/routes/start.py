...
async def start_command(message: types.Message):
    ...
    start_caption = (
        ...
        "🎁 Новый пользователь может один раз активировать пробные 3 дня.\n\n"
        "✨ Всё просто: выбери тариф, оплати в Telegram и подключайся!\n\n"
        "ℹ️ Обход региональных блокировок на данную секунду работает на ТЕЛЕ2, МТС, ЙОТА, но может перестать работать в любой момент.\n"
        "Вы всё равно можете использовать VPN.\n\n"

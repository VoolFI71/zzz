...
BTN_TRIAL = "🎁 Пробный доступ 3 дня"
...
# Profile
BTN_MY_CONFIGS = "📂 Мои подключения"
...
MSG_START_BRIEF = (
    "🛡️ <b>GLS VPN</b>\n\n"
    "🔐 Приватность • ⚡ Быстрая скорость • ⏱️ 2 минуты на настройку\n\n"
...
MSG_PROFILE_IMPORT_NOTE = (
    "Если импорт не сработал через мини‑приложение — скопируйте ссылку и вставьте в V2rayTun вручную."
)
